...
// SVG icon template — V in red circle on beige background
function iconSvg(size) {
  ...
  <text x="${size / 2}" y="${size / 2}" font-family="Arial,Helvetica,sans-serif" font-weight="bold" font-size="${fontSize}" fill="#F5F3EE" text-anchor="middle" dominant-baseline="central">V</text>
</svg>`;
}
